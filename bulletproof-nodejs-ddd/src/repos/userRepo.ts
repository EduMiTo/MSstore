...
export default class UserRepo implements IUserRepo {
  ...
  public async findByPhone (phone: UserPhone | string): Promise<User> {
  ...
  public async findAll() : Promise<Array<IUserDTO>> {
    return await this.userSchema.find() as unknown as Array<IUserDTO>;
  }
